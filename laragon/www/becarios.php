                ...
                <div class="form-group row">
                  ...
                  <div class="box"  style="margin-left:25px">
                    ...
                    <form target="" method="get" name="form" class="form-group row" style="margin-left:25px">
                        ...
                        <input name="matricula" id='matricula'type="text" class="md-input" value="" style="margin:20px;" required>
          ...
          <div class="row">
            <div class="col-sm-9">
                    ...
                    <table class="table table-striped b-t">
                      ...
                      <?php
                            ...
                            if (!empty($users_traffic_device)) {
                                ...
                                for ($i = 0; $i < count($users_traffic_device)-1; ) {
                                  if($users_traffic_device[$i]['traffic_state']==0 && $users_traffic_device[$i+1]['traffic_state']==1){
                                    $time_start = strtotime($users_traffic_device[$i]['traffic_date']);
                                    $time_end = strtotime($users_traffic_device[$i+1]['traffic_date']);
                                    if (date("Y-m-d", $time_start) == date("Y-m-d", $time_end)) {
                                      if(($time_end - $time_start) > 0 ){
                                        $time_full = $time_full + ($time_end - $time_start);
                                        $i += 2; 
                                        $jobs_ += 1;
                                      }
                                    }
                                ...
                                for ($i = 0; $i < count($users_traffic_device); $i++) {
                                    echo "<tr>";
                                    echo "<td>" . $users_traffic_device[$i]['traffic_id'] . "</td>";
                                    echo "<td>" . $users_traffic_device[$i]['traffic_date'] . "</td>";
                                    echo "<td>" . $users_traffic_device[$i]['hab_name'] . "</td>";
                                    echo "<td>" . $users_traffic_device[$i]['hab_registration'] . "</td>";
                                    echo "<td>" . $users_traffic_device[$i]['hab_email'] . "</td>";
                                    echo "<td>" . $users_traffic_device[$i]['traffic_device'] . "</td>";
                                    echo "<td>" . $users_traffic_device[$i]['traffic_state'] . "</td>";
                                    echo "</tr>";
                                }
                            } else {
                ...
                <div class="col-sm-3">
                  <div class="box">
                    <div class="box-header">
                      <h1 style="text-align:center;">Horas  de servicio: </h1>
                      <br>
                      <h1 style="color:#0cc2aa;text-align:center;font-weight: bold;"><?php echo round($time_full/ 3600, 4); ?></h1>
                  </div>
                  <div class="box">
                    <div class="box-header">
                      <h1 style="text-align:center;">Número de asistencias: </h1>
                      <br>
...
function enviarDatos() {
            ...
            xhr.open('POST', 'becarios.php', true);
